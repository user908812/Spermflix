    ...
    return(
        <div className={styles.errorPageContainer}>
            <div className={styles.center}>
                <img className={styles.sadEmoji} width={300} height={300} src={SadEmojiIcon} alt="sad-emoji" draggable={false} />
            </div>
                ...
                <div className={styles.buttonContainer}>
                    <Link to="/Spermflix"><button className={styles.goBackBTN}>Go back</button></Link>
                </div>
        </div>
    );
}
